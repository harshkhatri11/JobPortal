...
public class WebSecurityConfig {
    ...
    @Autowired
    public WebSecurityConfig(CustomUserDetailsService customUserDetailsService, CustomAuthenticationSucessHandler customAuthenticationSucessHandler) {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(form->form.loginPage("/login").permitAll()
                .successHandler(customAuthenticationSucessHandler)).logout(logout->{
